...
I build web applications, developer tools, server software, plugins, bots, automation tools, networking projects, system related software, and other experimental projects

I also work with Minecraft server development including server software, plugins, utilities, and tools for server developers and owners
...
I believe that sharing source code allows developers to learn from each other, improve existing projects, and build new ideas together

I try to contribute as much as I can by creating projects, improving existing software, reporting issues, sharing ideas, and helping other developers whenever possible
...
I enjoy exploring how software communicates with hardware, how operating systems manage resources, how servers work, and how different components interact with each other
...
I want to understand technology not only from the surface but also how it works internally
...
Every project gives me an opportunity to improve my skills, understand new technologies, solve problems, and contribute something useful
